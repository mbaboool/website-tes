...
const Fluid = () => {
    ...
    useEffect(() => {
        ...
        function pointerPrototype() {
            ...
            this.down = false;
            this.moved = false;
            this.color = [1.0, 0.84, 0.0]; // Golden color (RGB values for gold)
        }

        let initialPointer = new pointerPrototype();
        pointers.push(initialPointer);
        ...
        function multipleSplats(amount) {
            for (let i = 0; i < amount; i++) {
                const color = [1.0, 0.84, 0.0]; // Golden color
        ...
        const handleMouseMove = e => {
            pointers[0].moved = true; // Always set to true
